...
foreach ($result as $row)
{
	...
	$lessons[] = array('lessonID' => $row['lessonID'], 'assetID' => $row['assetID'], 'lesson_title' => $row['lesson_title'], 'lesson_number' => $row['lesson_number'], 'lesson_topic' => $row['lesson_topic'], 'lesson_sequence' => $row['lesson_sequence'], 'courseID' => $row['courseID'], 'course_name' => $row['course_name']);

}

include 'html/lessons.html.php';
